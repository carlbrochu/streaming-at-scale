...
echo "***** [C] setting up COMMON resources"
    ...
    if [ ! -z "$RUN" ]; then
        ../../components/create-resource-group.sh
        ../../components/blobstorage/create-storage-account.sh
    fi
echo 
...
echo "***** [I] Setting up INGESTION"
    ...
    if [ ! -z "$RUN" ]; then
        ../../components/eventhub/create-event-hub.sh
    fi
echo
...
echo "***** [D] Setting up DATABASE"
    ...
    if [ ! -z "$RUN" ]; then
        ../../components/cosmosdb/create-cosmosdb.sh
    fi
echo
...
echo "***** [P] Setting up PROCESSING"
    ...
    if [ ! -z $RUN ]; then
        ../../components/create-databricks.sh

        # Run solution specific configuration
        ./_setup-databricks.sh
    fi
echo
